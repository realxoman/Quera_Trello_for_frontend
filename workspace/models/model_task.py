...
class Task(DateBasic):
    ...
    description = models.TextField(_("توضیحات"), max_length=500, blank=True)
    ...
    thumbnail = models.ImageField(
        blank=True, null=True, upload_to="profile_pics", verbose_name="تصویر پروفایل"
    )
    attachment = models.FileField(
        blank=True, null=True, upload_to="attachments", verbose_name="فایل ضمیمه"
    )
