...
workspaces_routers = routers.NestedDefaultRouter(router, "", lookup="workspace")
...
projects_routers.register("members", ProjectMemberViewSet, basename="project-members")
projects_routers.register("boards", BoardViewSet, basename="boards")

# Boards endpoints
boards_routers = routers.NestedDefaultRouter(projects_routers, "boards", lookup="board")
boards_routers.register("tasks", TaskViewSet, basename="board-tasks")

# Tasks endpoints
tasks_routers = routers.NestedDefaultRouter(boards_routers, "tasks", lookup="task")
tasks_routers.register("assignee", TaskAssigneeViewSet, basename="task-assignee")
tasks_routers.register("comments", TaskCommentViewSet, basename="task-comments")
tasks_routers.register("logs", TaskLogViewSet, basename="task-logs")
